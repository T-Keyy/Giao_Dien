package ThuaKe;
	...
	public class Student1 extends Person1{
		...
		public Student1(String studentID, int academic_year, float gpa, float social_activities) {
			this.studentID = studentID;
			this.academic_year = academic_year;
			this.gpa = gpa;
			this.social_activities = social_activities;
		}
		public Student1(String studentID, String name, char gender, int birth_year, int academic_year, float gpa, float social_activities) {
