package lop_LopAo_GiaoDien;
	...
	public class WorkerKeThuaPerson extends lopAoPerson implements payTax {
		// Thuoc tinh
		...
		public  WorkerKeThuaPerson(String name, int citizenID,int phone, String email, Double salary, Double other_income) {
	 ...
	 // Ham hien thi
	    ...
	    public static void main(String[] args) {
	    	// TODO Auto-generated method stub
	    	 WorkerKeThuaPerson P = new  WorkerKeThuaPerson(name, citizenID, phone, email, salary, other_income);
	    	P.enter();
	    	P.display();
	  	}
